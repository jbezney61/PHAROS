#!/usr/bin/env python
"""
embedding_manifold_qc_analysis.py
...
def run_build_reference(args: argparse.Namespace) -> dict[str, Any]:
    ...
    from embedding_manifold_qc import build_reference_manifold
...
def run_score_query(args: argparse.Namespace) -> dict[str, Any]:
    ...
    from embedding_manifold_qc import run_query_manifold_qc
    ...
    if args.skip_report:
        ...
        from make_embedding_manifold_qc_report import make_embedding_manifold_qc_report
